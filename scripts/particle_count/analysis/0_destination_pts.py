# The general idea for the analysis:
# Run a bunch of simulations with x amount of points.
# Create a raster of point count (5km cell size) for all of the point destinations.
# Then create rasters with a random selection of 5%, 10%, 15%...95% of the points.
# Compare each raster to the full raster to see how related they are -
# use the Band Stastics tool in ArcGIS and the Correlation Matrix to calculate
# FUV, as is done in Simons et al. 2013.
