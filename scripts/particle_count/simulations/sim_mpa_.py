...
# In general for the simulations, I'm starting with the assumption that the 
# amount I released in the original simulations is sufficient, so I want to test
# levels lower than that. So for instance for mpa 62 (uID_202011), I did 72 
# particles per release. For 84 releases, this is 6048 particles.
# So, if I want to test with 20 individual simulations (similar to Simons et 
# al.), divide 72 by 20. That is about 4 particles per release. 4*84*20 = 6720 
# particles.

# I'm only doing this for a handful of MPAs, so I'm doing it one feature at a
# time.

# Particle number was added in as a new attribute to the shapefile.
