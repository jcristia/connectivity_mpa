# This is copied from the sdmTMB package.
# The only thing I changed is that new_data is no longer set to NULL, so now you
# can send the function new data that it will predict over and calculate
# residuals.
